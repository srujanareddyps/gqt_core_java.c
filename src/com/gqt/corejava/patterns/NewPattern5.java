...
/**@author Srujana
 * @category patterns
 * @description This is an example alphabet pattern 
 */
public class NewPattern5 {
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<n;i++) {
			...
			System.out.print("  ");
			for(int j=0;j<n;j++) {
				if(i == 0 ||(j == n / 2) ||(i == n - 1 && j < n / 2) ||(i >= n - 3 && j == 0))  
				{
					System.out.print("* ");
				}
				else {
			...
			System.out.print("  ");
			for(int j=0;j<n;j++) {
				if((i == 0 && j > 0) || (i == n / 2 && j > 0 && j < n - 1) ||  
	               (i == n - 1 && j < n - 1) ||(i < n / 2 && j == 0) ||(i > n / 2 && j == n - 1))     
				{
					System.out.print("* ");
				}
				else {
